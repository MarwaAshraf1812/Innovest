export class CommunityUsersDTO {
    constructor(data) {
...
export class UpdateCommunityUsersDTO {
    ...
    validate() {
        if (!this.user_id) throw new Error('Interest userId is required for updates');
    }
}

export default { CommunityUsersDTO, UpdateCommunityUsersDTO };
